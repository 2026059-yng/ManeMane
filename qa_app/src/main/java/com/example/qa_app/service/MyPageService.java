...
public class MyPageService extends BaseService {
    ...
    //固定費の項目名、金額を表示する
    public List<Monthly> showFixedCosts(int user_id) {
    ...
    //カテゴリーを表示する
    public List<CategoryEditForm> showCategoriesMypage(int user_id){
        return myPageRepository.findCategories(user_id);
    }
    
    //カテゴリを変更する
    public void changeCategories(int user_id, List<CategoryEditForm> list) {
